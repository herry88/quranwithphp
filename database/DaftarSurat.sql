...
--
-- Host: localhost
-- Generation Time: Feb 12, 2016 at 03:40 AM
...
--
-- Indexes for table `DaftarSurat`
--
ALTER TABLE `DaftarSurat`
...
--
-- AUTO_INCREMENT for table `DaftarSurat`
--
ALTER TABLE `DaftarSurat`
  MODIFY `index` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
